...
1. Go to [Releases](javascript:open("https://git.ft2.club/fred913/HeartbeatTracking/releases");) and find the latest one, the top of the list.
...
2. Go to [Releases](javascript:open("https://git.ft2.club/fred913/HeartbeatTracking/releases");) and find the latest one (the top of the list), and download the APK file from the `Files` section.
